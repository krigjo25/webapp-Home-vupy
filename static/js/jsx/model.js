  ...
  apps: [{
    ...
    schools: [{
      ...
      classes: [{
        ...
        languages: [{
          name: "C",
          tech: ["API", "C#", ".NET", "Data Structures"]
        }, {
          name: "Database-Management",
          tech: ["SQL"]
        }, {
          name: "UI",
          tech: ["HTML", "CSS", "JavaScript", "MVC"]
        }, {
          name: "Workflow",
          tech: ["agile-practices", "Customer-relations"]
        }]
      }]
    }, {
      school: "HavardX",
      ...
      },*/
      {
        ...
        languages: [{
          name: "Python",
          tech: ["Function-variables", "Conditionals", "Loops", "Exceptions", "Libraries", "Unit testing", "File I/O", "Regular Expressions", "Object Oriented Programming"]
        }]
      }]
    }]
  }, {
